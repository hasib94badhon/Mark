...
class UserDetail {
  ...
  factory UserDetail.fromJson(Map<String, dynamic> json) {
    return UserDetail(
      ...
      category: json['category'] ?? "No Category", // Provide default value if null
      business_name: json['business_name'] ?? "No Name", // Provide default value if null
      phone: json['phone'] as int?, // Cast as nullable int
      photo: json['photo'] ?? "No Photo", // Provide default value if null
      service_id: json['service_id'], // Assuming service_id will always be provided
    );
  }
}
